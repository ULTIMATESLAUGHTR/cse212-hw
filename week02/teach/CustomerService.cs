...
public class CustomerService {
    public static void Run() {
        ...
        // Defect(s) Found: ServeCustomer tries to remove before getting the customer
        ...
        service = new CustomerService(4);
        service.ServeCustomer();
        // Defect(s) Found: ServeCustomer doesn't check if queue is empty
        ...
        // Defect(s) Found: Condition should be >= instead of >
